...
class CityHandle extends AddressComponent{ //ES6新特性5：类(Class)和继承(Extends)
	constructor(){  //constructor 是一种用于创建和初始化class创建的对象的特殊方法。
		super()  //与this类似，super相当于是指向当前对象的父类，这样就可以用super.xxx来引用父类的成员。
